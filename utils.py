...
def print_log(epoch, num_epochs, one_epoch_time, train_psnr, val_psnr, val_ssim, exp_name):
    ...
    log_file_name = '{}_log.txt'.format(exp_name)
...
def adjust_learning_rate(optimizer, epoch, milestones=[100, 150], gamma=0.5):
    if epoch in milestones:
        for param_group in optimizer.param_groups:
            param_group['lr'] *= gamma
        print('Learning rate adjusted to {} at epoch {}.'.format(optimizer.param_groups[0]['lr'], epoch))
